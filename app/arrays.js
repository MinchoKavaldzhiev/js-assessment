arraysAnswers = {
  ...
  /**
   * Returns array arr excluding item. 
   * Added method to make test pass.
   * 
   * @param {Number[]} arr - An array of numbers
   * @param {Number} item - A number to be excluded from the new array
   * @returns {Number[]} A the array arr except item.
   */
  ...
  concat: function concat(arr1, arr2) {
    //Should this be manually implemented
